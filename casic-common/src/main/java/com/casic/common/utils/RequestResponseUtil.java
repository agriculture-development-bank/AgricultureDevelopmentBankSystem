...
import com.casic.common.xss.XssSqlHttpServletRequestWrapper;
...
public class RequestResponseUtil {
     ...
     * @Return java.lang.String
     */
    public static String getAttribute(ServletRequest request, String key) {
    ...
    public static void responseWrite(String outStr, ServletResponse response) {
    	...
    	logger.info("response message : "+outStr);
