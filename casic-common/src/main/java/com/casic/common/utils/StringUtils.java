...
import com.casic.common.support.StrFormatter;
...
public class StringUtils extends org.apache.commons.lang3.StringUtils
{
    ...
    /**
     * 
     * @param sysCode 系统编码foramt
     * @return 转换后的驼峰式命名的字符串
     */
    public static String formatSysCode(String sysCode) {
    	if(sysCode != null && sysCode.length() == 1 && !sysCode.startsWith("0")) {
    		return "0"+sysCode;
    	}else {
    		return sysCode;
    	}
	...
	public static int getInt(String str,Integer defaultData) {
		...
		try {
			...
			System.out.println("把String转换成int数据========== "+str);
		}
		return inum;
	}
