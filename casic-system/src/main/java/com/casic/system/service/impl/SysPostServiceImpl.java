...
import com.casic.system.domain.SysPost;
import com.casic.system.mapper.SysPostMapper;
import com.casic.system.mapper.SysUserPostMapper;
import com.casic.system.service.ISysPostService;
...
public class SysPostServiceImpl implements ISysPostService {
    ...
    public int insertPost(SysPost post) {
        if (post != null) {
            if ("".equals(post.getPostId()) || post.getPostId() == null) {
