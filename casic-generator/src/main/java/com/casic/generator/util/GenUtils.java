...
{
    /** 项目空间路径 */
    private static final String PROJECT_PATH = "main/java/com/casic";
    ...
    public static List<String> getTemplates()
    {
        ...
        templates.add("vm/oscurd/java/domain.java.vm");
        templates.add("vm/oscurd/java/Mapper.java.vm");
        templates.add("vm/oscurd/java/Service.java.vm");
        templates.add("vm/oscurd/java/ServiceImpl.java.vm");
        templates.add("vm/oscurd/java/Controller.java.vm");
        templates.add("vm/oscurd/xml/Mapper.xml.vm");
        templates.add("vm/oscurd/html/list.html.vm");
        templates.add("vm/oscurd/html/add.html.vm");
        templates.add("vm/oscurd/html/edit.html.vm");
        templates.add("vm/oscurd/sql/sql.vm");
        return templates;
    }
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println(getModuleName("com.casic.system"));
    }
}
