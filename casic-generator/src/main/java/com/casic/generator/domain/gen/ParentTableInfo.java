 ...
 * @author yuzengwen
 */
public class ParentTableInfo extends BaseEntity
{
    ...
    /** 一对多关系*/
    private List<TableInfo> childTableList;
	...
	public List<TableInfo> getChildTableList() {
		return childTableList;
	}

	public void setChildTableList(List<TableInfo> childTableList) {
