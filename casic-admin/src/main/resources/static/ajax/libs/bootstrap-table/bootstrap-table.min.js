    ...
    function (j) {
        ...
        e.prototype.initHeader = function () {
            ...
            j.each(this.options.columns, function (v, u) {
                ...
                j.each(u, function (B, A) {
                    ...
                    s.push("<th" + m(' title="%s"',
                        A.titleTooltip),
                        A.checkbox || A.radio ? m(' class="bs-checkbox %s"', A["class"] || "") : D,
                        m(' style="%s"', C + w),
                        m(' rowspan="%s"', A.rowspan),
                        m(' colspan="%s"', A.colspan),
                        m(' data-field="%s"', A.field),
                        "tabindex='0'", ">"
                    );
            ...
            this.$container.off("click", ".th-inner").on("click", ".th-inner", function (u) {
                ...
                if (t.options.detailView) {
                    if (v.closest("." + tableId)[0] !== t.$container[0]) {
                        return false
                    }
                }
            ...
            if (!this.options.showHeader || this.options.cardView) {
                ...
                this.getCaret();
                j(window).on("resize."+tableId, j.proxy(this.resetWidth, this))
            }
        ...
        e.prototype.initToolbar = function () {
            ...
            if (this.options.showSearch) {
                t.push(
                    m('<button class="btn' +
                        ...
                        '" type="button" name="showSearch" title="%s">', this.options.formatSearch()
                    ),
                    m('<i class="%s %s"></i>',
                        this.options.iconsPrefix,
                        this.options.icons.search
                    ),
                    "</button>"
                )
            }
            if (this.options.showPaginationSwitch) {
                t.push(
                    m('<button class="btn' +
                        m(" btn-%s", this.options.buttonsClass) +
                        m(" btn-%s", this.options.iconSize) +
                        '" type="button" name="paginationSwitch" title="%s">', this.options.formatPaginationSwitch()
                    ),
                    m('<i class="%s %s"></i>',
                        this.options.iconsPrefix,
            ...
            if (this.options.showRefresh) {
                t.push(
                    m('<button class="btn' +
                        m(" btn-%s", this.options.buttonsClass) +
                        m(" btn-%s", this.options.iconSize) +
                        '" type="button" name="refresh" title="%s">', this.options.formatRefresh()
                    ),
                    m('<i class="%s %s"></i>',
                        this.options.iconsPrefix,
            ...
            if (this.options.showToggle) {
                t.push(
                    m('<button class="btn' +
                        m(" btn-%s", this.options.buttonsClass) +
                        m(" btn-%s", this.options.iconSize) +
                        '" type="button" name="toggle" title="%s">', this.options.formatToggle()
                    ),
                    m('<i class="%s %s"></i>',
                        this.options.iconsPrefix,
            ...
            if (this.options.showColumns) {
                t.push(
                    m('<div class="keep-open btn-group" title="%s">', this.options.formatColumns()),
        ...
        e.prototype.initPagination = function () {
            ...
            if (!this.options.onlyInfoPagination) {
                ...
                var C = [
                    m('<span class="btn-group %s">', this.options.paginationVAlign === "top" || this.options.paginationVAlign === "both" ? "dropdown" : "dropup"),
                    '<button type="button" class="btn' + m(" btn-%s", this.options.buttonsClass) + m(" btn-%s", this.options.iconSize) + ' dropdown-toggle" data-toggle="dropdown">',
                ...
                w.push("</div>",
                    ...
                    '<ul class="pagination' + m(" pagination-%s", this.options.iconSize) + '">',
                ...
                if (this.totalPages >= 6) {
                    if (this.options.pageNumber >= 3) {
                        w.push('<li class="page-first' + (1 === this.options.pageNumber ? " active" : "") + '">',
                    ...
                    if (this.options.pageNumber >= 4) {
                        if (this.options.pageNumber == 4 || this.totalPages == 6 || this.totalPages == 7) {
                            ...
                            w.push('<li class="page-first-separator disabled">',
                ...
                for (v = D; v <= E; v++) {
                    w.push('<li class="page-number' + (v === this.options.pageNumber ? " active" : "") + '">',
                        '<a href="javascript:void(0)">',
                        v,
                        "</a>",
                        "</li>")
                ...
                if (this.totalPages >= 8) {
                    if (this.options.pageNumber <= (this.totalPages - 4)) {
                        w.push('<li class="page-last-separator disabled">',
                            '<a href="javascript:void(0)">...</a>',
                            "</li>"
                        )
                    }
                ...
                if (this.totalPages >= 6) {
                    if (this.options.pageNumber <= (this.totalPages - 3)) {
                        w.push('<li class="page-last' + (this.totalPages === this.options.pageNumber ? " active" : "") + '">',
                            '<a href="javascript:void(0)">',
                            this.totalPages,
                            "</a>",
                            "</li>"
                ...
                w.push('<li class="page-next"><a href="javascript:void(0)">' + this.options.paginationNextText + "</a></li>",
                    "</ul>",
                    "</div>"
                )
            }
        ...
        e.prototype.initBody = function (x) {
            ...
            for (var w = this.pageFrom - 1; w < this.pageTo; w++) {
                ...
                y.push(
                    "<tr",
                    m(" %s", A.join(" ")),
                    m(' id="%s"', j.isArray(C) ? undefined : C._id),
                    m(' class="%s"', r.classes || (j.isArray(C) ? undefined : C._class)),
                    m(' data-index="%s"', w),
                    m(' data-uniqueid="%s"', C[this.options.uniqueId]),
                    m("%s", t),
                    ">"
                );
                if (this.options.cardView) {
                    y.push(
                        m('<td colspan="%s"><div class="card-views">', this.header.fields.length)
                    )
                }
                if (!this.options.cardView && this.options.detailView) {
                    y.push(
                        ...
                        m('<i class="%s %s"></i>', this.options.iconsPrefix, this.options.icons.detailOpen),
                        "</a>",
                        "</td>")
                }
                j.each(this.header.fields, function (I, L) {
                    ...
                    if (F.checkbox || F.radio) {
                        ...
                        K = F.radio ? "radio" : K;
                        P = [
                            m(z.options.cardView ? '<div class="card-view %s">' : '<td class="bs-checkbox %s">', F["class"] || ""),
                            "<input" +
                            m(' data-index="%s"', w) +
                            m(' name="%s"', z.options.selectItemName) +
                            m(' type="%s"', K) +
                            m(' value="%s"', C[z.options.idField]) +
                            m(' checked="%s"', M === true || (M && M.checked) ? "checked" : undefined) +
                            m(' disabled="%s"', !F.checkboxEnabled || (M && M.disabled) ? "disabled" : undefined) +
                            " />",
                            z.header.formatters[I] && typeof M === "string" ? M : "",
                            z.options.cardView ? "</div>" : "</td>"
                        ].join("");
                        ...
                        P = z.options.cardView ?
                            [
                                '<div class="card-view">',
                                z.options.showHeader ? m('<span class="title" %s>%s</span>', r, c(z.columns, "field", "title", L)) : "",
                                m('<span class="value">%s</span>', M),
                                "</div>"
                            ].join("") :
                            [
                                m("<td%s %s %s %s %s %s %s>", Q, J, r, G, O, R, H),
                                M,
                                "</td>"
                            ].join("");
            ...
            if (!y.length) {
                y.push(
                    ...
                    m('<td colspan="%s">%s</td>', this.$header.find("th").length, this.options.formatNoMatches()),
                    "</tr>"
                )
            }
            ...
            this.$body.find("> tr[data-index] > td").off("click dblclick").on("click dblclick", function (J) {
                var D = j(this), F = D.parent(), M = z.data[F.data("index")],
                    H = D[0].cellIndex, G = z.getVisibleFields(),
                    K = G[z.options.detailView && !z.options.cardView ? H - 1 : H],
                    E = z.columns[i(z.columns, K)], L = o(M, K, z.options.escape);
        ...
        e.prototype.initServer = function (r, w, s) {
            var u = this, v = {},
                x = {searchText: this.searchText, sortName: this.options.sortName, sortOrder: this.options.sortOrder},
                t;
            if (this.options.pagination) {
        ...
        e.prototype.fitHeader = function () {
            ...
            this.$header.find("th[data-field]").each(function (B) {
                ...
                t.$header_.find(m('th[data-field="%s"]', j(this).data("field"))).width(j(this).innerWidth())
            });
        ...
        e.prototype.initTableId = function (r) {
            tableId = r.hasOwnProperty("tableId");
        };
        ...
        e.prototype.mergeCells = function (z) {
            var y = z.index, t = j.inArray(z.field, this.getVisibleFields()), u = z.rowspan || 1, s = z.colspan || 1, w,
                v, x = this.$body.find(">tr"), r;
        ...
        var n = ["getOptions", "getSelections", "getAllSelections", "getData", "load", "append", "prepend", "remove", "removeAll", "initTableId", "insertRow", "updateRow", "updateCell", "updateByUniqueId", "removeByUniqueId", "getRowByUniqueId", "getRowByIndex", "removeByIndex", "showRow", "hideRow", "getRowsHidden", "mergeCells", "checkAll", "uncheckAll", "checkInvert", "check", "uncheck", "checkBy", "uncheckBy", "refresh", "resetView", "resetWidth", "destroy", "showLoading", "hideLoading", "showColumn", "hideColumn", "getHiddenColumns", "getVisibleColumns", "showAllColumns", "hideAllColumns", "filterBy", "scrollTo", "getScrollPosition", "selectPage", "prevPage", "nextPage", "togglePagination", "toggleView", "refreshOptions", "resetSearch", "expandRow", "collapseRow", "expandAllRows", "collapseAllRows", "updateFormatText"];
